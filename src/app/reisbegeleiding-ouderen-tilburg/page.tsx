          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-xl text-gray-700 mb-8 leading-relaxed">
                ...
                Vliegklaar biedt persoonlijke begeleiding op maat voor senioren in Noord-Brabant.
              </p>
            ...
            <div className="flex-1 relative h-[300px] md:h-[400px] w-full rounded-2xl overflow-hidden shadow-2xl">
              <Image
                src="https://images.unsplash.com/photo-1616448318043-8557874917a2?w=800&q=80"
                alt="Tilburg Stad"
                fill
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-gray-600">
                Wij halen u thuis op in Tilburg (of omgeving zoals Breda, Oisterwijk, Goirle) 
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600">
                Onze begeleiders kennen de regio Midden-Brabant en Eindhoven Airport goed, wat zorgt voor een zorgeloze start van uw reis.
              </p>
            </div>
            <div className="space-y-4">
      ...
      <section className="py-20 bg-primary-900 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-10 text-primary-100">
            Wilt u de mogelijkheden bespreken voor uw volgende reis? Bel ons voor een vrijblijvend adviesgesprek bij u thuis in Tilburg.
          </p>
          <a
            href="tel:0618769492"
